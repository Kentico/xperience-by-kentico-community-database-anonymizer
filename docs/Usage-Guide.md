...
- **Individual fields** — enter the data source, authentication method, and credentials (if Integrated Security is not selected). The tool will then list the available databases on the server for you to pick from.
